...
@router.post("/", status_code=status.HTTP_201_CREATED, response_model=CursoShema)
async def post_curso(curso: CursoShema, db: AsyncSession = Depends(get_session)):
...
@router.get("/", response_model=List[CursoShema])
